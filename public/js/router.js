	...
	window.GSWAT.prototype.router = Backbone.Router.extend({
		...
		render_home: function(){
			var files = [
				...
				PBF.CDN + 'js/models/model.chat.js',
		...
		render_login: function(){
			var files = [
				PBF.CDN + 'js/models/model.account.js',
				PBF.CDN + 'js/views/view.account.js'
			];
			PBF.load(files,function(){
		...
		render_map_rotation: function(){
			var files = [
				PBF.CDN + 'js/models/model.server.js',
				PBF.CDN + 'js/models/model.map-rotation.js',
				PBF.CDN + 'js/views/view.map-rotation.js'
			];
			PBF.load(files,function(){
				var server = PBF.get({model:{name:'server_model'}});
